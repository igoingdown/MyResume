...
\cventry{\small{2021.07-至今}}{\textcolor[RGB]{64,127,191}{字节跳动}}{电商}{服务端研发工程师}{获 spotbonus 3 次}{
    \begin{itemize}
        ...
        \newline 业务玩法建设：从0到1建设多个业务玩法，包括签到和报销机等，玩法在商城新入口 GMV 渗透 \textbf{7+\%}
        \newline 玩法效率探索：红包雨发券引入算法模型，GMV 转化率高于运营配置，玩法 GMV\_ROI 长期显著 > \textbf{1}
        \newline 玩法商业化建设：建立红包雨玩法商业化机制，单月收入 > 1000w ，实现玩法收支平衡
        \newline 技术基础设施建设：多玩法共通依赖现金发放与管理能力，抽象钱包系统并落地，支撑 3+ 玩法活动上线；对于玩法通用能力进行梳理，建设组件 SDK ，已沉淀 feed、任务列表等通用能力
        ...
        \newline 链路治理：完成 B 端和 C 端导购链路强弱依赖梳理，召回稳定性 P0 问题 \textbf{10+}，落地改进 \textbf{4} 个
