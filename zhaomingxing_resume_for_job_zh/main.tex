...
\cventry{2012--2016}{北京邮电大学}{计算机科学与技术学院}{本科}{}{校级三等奖学金}
...
\section{工作经历}
\cventry{\small{2021.07-至今}}{\textcolor[RGB]{64,127,191}{字节跳动}}{电商}{服务端研发工程师}{获 spotbonus 3 次}{
    \begin{itemize}
        \item \textcolor[RGB]{64,127,191}{商城活动方向负责人}
        \newline 业务玩法建设：从零到 1 建设多个业务玩法，包括签到和报销机等，推全后玩法在商城新入口 GMV 渗透 \textbf{7\%}
        \newline 存量玩法效率探索：红包雨玩法发券引入算法模型，实现成本控制，GMV 转化率高于运营配置，玩法 GMV\_ROI 长期显著 > \textbf{1}
        \newline 玩法商业化建设：建立红包雨玩法商业化机制，单月收入 > 1000w ，实现玩法收支平衡
        \newline 技术基础设施建设：多玩法共通依赖现金发放能力，抽象活动钱包系统并落地，支撑 3+ 个玩法活动上线；对于玩法通用能力进行梳理，建设组件 SDK ，目前已沉淀 feed、任务列表等通用能力
        \newline 业务效率提升：规划并落地玩法后台，目前已支持 3 个玩法配置，配置成本显著降低，玩法配置 0 RD 投入。多玩法上线过程中，沉淀全过程 SOP 文档 \textbf{10+}，显著提升开发、测试与 oncall 效率
        ...
        \newline 作为电商大促横向 RD POC 统筹活动全流程各团队 RD 工作，与 PM、QA、业务 POC 紧密合作推动大促活动落地
        \newline 大促全链路效率提升：推进全链路接入时间穿梭能力，测试&玩法预演效率提升 \textbf{1倍+}
        \item \textcolor[RGB]{64,127,191}{营销中台稳定性建设}
        \newline 压测模型校准：分析历史压测链路，定位压测缓存穿透率低问题，建设通用压测缓存穿透 sdk，缓存穿透率\textbf{0.1\%\->50\%}，压测精度提升
        \newline 强弱依赖梳理：完成 C 端导购链路梳理，\textbf{40\%}。
        \newline 黑名单稳定性重保：业务针对权益资损问题建设黑名单 sdk，导购和交易链路均强依赖，梳理 sdk 逻辑，从 panic 预防、监控报警建设、性能测试、降级预案维度进行保障，上线后稳定承接流量\textbf{1000w+}QPS 。
        \newline 稳定性工具建设：建设营销中台稳定性监控大盘，帮助业务发现&定位问题；开发稳定性工具脚本仓库，支持按服务树节点拉取全量faas 脚本及触发器配置、全量 psm 报警配置，实现消费限速巡检报警 review 提效。
    \end{itemize}}
...
\cventry{\small{2019.01-至今}}{字节跳动}{}{服务端研发工程师-内推达人}{}{
    \begin{itemize}
