...
\cventry{\small{2021.07-至今}}{\textcolor[RGB]{64,127,191}{字节跳动}}{中国电商}{后端开发工程师}{获 spotbonus 3 次}{
    \begin{itemize}
        \item \textcolor[RGB]{64,127,191}{AI 探索}
        \newline \textbf{AI Skill 建设}：创建 AI Skill，实现框架分支代码自动生成，生成完成后自动通知用户更新依赖，使用 Skill 自动操作取代平台手动操作，降低平台操作门槛并显著提升研发效率
        \newline \textbf{效率提升}：AI Skill 截至目前累计下载 \textbf{10736} 次，持续为业务开发提效
        \item \textcolor[RGB]{64,127,191}{商城营销活动方向负责人}
        \newline \textbf{业务建设}：从 0 到 1 建设多个业务玩法，包括签到和报销机等，玩法在商城新入口 GMV 渗透 7+\%
        \newline \textbf{玩法效率探索}：红包雨发券引入算法模型，GMV 转化率高于运营配置，玩法 GMV\_ROI 长期显著 > 1
        \newline \textbf{商业化建设}：建设红包雨玩法商业化机制，单月收入 > 1000w ，实现玩法收支平衡
        \newline \textbf{技术建设}：多玩法共通依赖现金发放与管理能力，抽象钱包系统并落地，支撑 3+ 玩法活动上线；对于玩法通用能力进行梳理，建设组件 SDK ，已沉淀 feed、任务列表等通用能力
        \newline \textbf{能效提升}：规划并落地玩法后台，目前已支持 3 个玩法配置，配置成本显著降低，玩法配置上线 RD 0 投入。多玩法上线过程中，沉淀全过程 SOP 文档 10+，显著提升开发、测试与 oncall 效率
        \newline \textbf{稳定性建设}：在多玩法落地过程中，为每个玩法分别梳理并落地稳定性方案，5+ 玩法集中上线 0 Fatal；梳理稳定性方案模板，模板使用 UV 10+
        \item \textcolor[RGB]{64,127,191}{商城金币激励方向负责人 }
        \newline \textbf{业务建设}：从玩法引流、金币发放、核销效率三方面提升玩法规模，Y25H1 玩法引导 GMV 提升 \textbf{100+\%}
        \newline \textbf{技术建设}：深入业务逻辑和技术架构，提出多项问题与风险，推动完成Y25H1 \& Y25H2 规划， 其中 H1 规划落地质量较高，业务与技术收益显著，我所指导的同学绩效较好，顺利晋升。
        \newline \textbf{稳定性建设}：针对权益发放与核销阶段资损风险建设并落地多项对账，召回多个业务风险并修复
         \item \textcolor[RGB]{64,127,191}{电商大促研发负责人}
        \newline \textbf{业务建设}：作为电商大促横向 RD POC 统筹各团队 RD 工作，与 PM、QA、业务 POC 紧密合作推动大促活动落地，有效保障了 Y23 618 和 双 11 的平稳落地，大促期间 0 主责事故
        \newline \textbf{全链路效能提升}：推进全链路接入时间穿梭能力，大促玩法测试、预演效率提升 \textbf{1倍+}
        \item \textcolor[RGB]{64,127,191}{营销中台稳定性建设}
        \newline \textbf{问题预防}：推动 B 端和 C 端导购链路接入 panic 检测，召回并解决 3+ panic 问题
        \newline \textbf{链路治理}：完成 B\&C 端链路强弱依赖梳理，召回 P0 问题 10+，落地改进 4 个
        \newline \textbf{监控建设}：建设稳定性监控大盘，覆盖全链路 psm 和基础组件，显著提升了问题排查效率；建设日志降采样大盘，规划并落地日志清理专项，C 端日志降采样率降至 0
        \newline \textbf{报警治理}：开发爬虫脚本抓取全量报警规则数据，review 并修改报警规则；与 QA 建设定期报警治理机制，消防群报警数显著下降 80+\%，报警响应率长期保持 100\%
        \newline \textbf{压测提效}：分析历史压测链路，定位压测缓存穿透率低问题，建设通用压测缓存穿透 sdk，缓存穿透率 0.1\%->50\%，压测精度提升
        \newline \textbf{工具建设}：开发稳定性工具脚本仓库，支持按服务树节点拉取全量faas 脚本及触发器配置、全量 psm 报警配置，实现消费限速巡检报警 review 提效
        \newline \textbf{专项重保}：业务针对权益资损问题建设黑名单 sdk，导购和交易链路均强依赖，梳理 sdk 逻辑，从 panic 预防、监控报警建设、性能测试、降级预案维度进行保障，上线后稳定承接流量\textbf{1000w+}QPS
    \end{itemize}}
